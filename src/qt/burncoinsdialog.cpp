...
void BurnCoinsDialog::on_sendButton_clicked()
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this,
                                                               tr("Confirm burn coins"),
                                                               tr("Are you sure you want to burn %1?").arg(formatted.join(tr(" and "))),
    ...
    WalletModel::SendCoinsReturn sendstatus = model->sendCoins(recipients, NULL);

    switch(sendstatus.status)
    {
    case WalletModel::InvalidAddress:
        QMessageBox::critical(this, tr("Burn Coins"),
