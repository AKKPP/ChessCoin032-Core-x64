...
bool CDBEnv::Open(boost::filesystem::path pathEnv_)
{
    ...
    int nDbCache = GetArg("-dbcache", 25);  // Default cache size set to 25MB

    dbenv.set_lg_dir(pathLogDir.string().c_str());
    dbenv.set_cachesize(nDbCache / 1024, (nDbCache % 1024) * 1048576, 1);
    dbenv.set_lg_bsize(1048576);  // Log buffer size set to 1MB
    dbenv.set_lg_max(10485760);   // Max log file size set to 10MB
